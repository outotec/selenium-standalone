...
function start(opts, cb) {
  ...
  console.log("checkPathsExistence(" + getInstallPaths(fsPaths) + ")");
  checkPathsExistence(getInstallPaths(fsPaths), function(err) {
    ...
    console.log("spawning selenium");
    var selenium = spawn(opts.javaPath, args, opts.spawnOptions);
    console.log("forward selenium to spawnCb");
    ...
    checkStarted(args, function started(err) {
      console.log("callback for checkStarted()");
    ...
    function errorIfNeverStarted(code) {
      ...
      console.log("errorIfNeverStarted(" + code + ")");
      neverStarted = true;
